...
import DataBanner from "../images/databanner.jpg";
...
const DataSources = () => {
    ...
    return (
        ...
        <HeaderImage>
        <img src={DataBanner} alt="Browse Star Systems" title="Browse Star Systems" style={{color: "#ffffff", width: "100%", height: "100%"}}/>
        </HeaderImage>
