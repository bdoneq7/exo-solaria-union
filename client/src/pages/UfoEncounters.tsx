...
import CigarIcon from "../images/ufo/cigar_icon.png";
import DonutIcon from "../images/ufo/donut_icon.png";
import BallIcon from "../images/ufo/ball_icon.png";
import RedBallIcon from "../images/ufo/ballred_icon.png";
import GreenBallIcon from "../images/ufo/ballgreen_icon.png";
import BlueGreenBallIcon from "../images/ufo/ballbluegreen_icon.png";
import BallWhiteIcon from "../images/ufo/ballwhite_icon.png";
...
const UfoEncounters = () => {
    ...
    return (
        ...
        <SightingContainer>
        <SightingImage>
        <img src={DonutIcon} alt="Browse Star Systems" title="Browse Star Systems" style={{color: "#ffffff", width: "100px", height: "31px"}}/>
        </SightingImage>  
        <SightingContent>
            June 28, 1947: Maury Island, Washington<br/><br/>
        ...
        <SightingContainer>
        <SightingImage>
        <img src={SaucerIcon} alt="Browse Star Systems" title="Browse Star Systems" style={{color: "#ffffff", width: "100px", height: "31px"}}/>
        
        </SightingImage>  
        <SightingContent>
            Summer 1947: <Link to="/RoswellNewMexico" >Roswell, New Mexico</Link> 
        <br/><br/>
        ...
        <SightingContainer>
        <SightingImage>
        <img src={CigarIcon} alt="Browse Star Systems" title="Browse Star Systems" style={{color: "#ffffff", width: "100px", height: "31px"}}/>
        
        </SightingImage>  
        <SightingContent>
            July 1948: Montgomery, Alabama <br/><br/>
        ...
        <SightingContainer>
        <SightingImage>
        <img src={BallWhiteIcon} alt="Browse Star Systems" title="Browse Star Systems" style={{color: "#ffffff", width: "75px", height: "75px"}}/>
        
        </SightingImage>  
        <SightingContent>
            Oct 1, 1948: Fargo, North Dakota <br/><br/>
        ...
        <SightingContainer>
        <SightingImage>
        <img src={GreenBallIcon} alt="Browse Star Systems" title="Browse Star Systems" style={{color: "#ffffff", width: "75px", height: "75px"}}/>
        
        </SightingImage>  
        <SightingContent>
            Dec 1948: Los Alamos, New Mexico <br/><br/>
        ...
        <SightingContainer>
        <SightingImage>
        <img src={BlueGreenBallIcon} alt="Browse Star Systems" title="Browse Star Systems" style={{color: "#ffffff", width: "75px", height: "75px"}}/>
        
        </SightingImage>  
        <SightingContent>
            Aug 1951: Lubbock, Texas <br/><br/>
        ...
        <SightingContent>
            July 1952: Washington, D.C. <br/><br/>
        ...
        <SightingContent>
            Aug 1952: Everglades, Florida  <br/><br/>
        ...
        <SightingContent>
            Sep 1952: North Yorkshire, England<br/><br/>
        ...
        <SightingContent>
            Nov 23, 1953: Keweenaw Point, Michigan <br/><br/>
        ...
        <SightingContainer>
        <SightingImage>
        <img src={TriangleIcon} alt="Browse Star Systems" title="Browse Star Systems" style={{color: "#ffffff", width: "100px", height: "31px"}}/>
        </SightingImage>  
        <SightingContent>
            Dec 1980: Rendlesham Forest, England <br/><br/>
        ...
        <SightingContent>
            1995: Alaska? <br/><br/>
            Pilots on KC-135 Aircraft on mission to resupply bombers see very bright ufo descend through aurora borealis and ascend quickly.
        </SightingContent>
        </SightingContainer>
        ...
        <SightingContent>
            March 13, 1997: Phoenix, Arizona <br/><br/>
        ...
        <SightingContainer>
        <SightingImage>
        <img src={TicTacIcon} alt="Browse Star Systems" title="Browse Star Systems" style={{color: "#ffffff", width: "100px", height: "31px"}}/>
        </SightingImage>
        <SightingContent>
            November 10, 2004: USS Nimitz Carrier Group in Pacific Ocean near San Diego <br/><br/>
        ...
        <SightingContent>
            Jan 8, 2008: Stephensville, TX <br/>
