        ...
        <div className='starsystems'>
          <div className='container'>
            ...
            <div className='centered-labeltitle'>
                <GiSolarSystem size='70' className='iconmain' alt="Star System List" title="Star System List" /><h2><span className="titleblue">Star System List</span>   801 - 1,000 Light Years</h2>
            </div>
...
export default StarSystems801to1000;